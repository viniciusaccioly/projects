...
# Dtls
import ssl
from dtls import wrap_server, wrap_client
# CoAPthon
...
class coapDtlsClient(object):
 def __init__(self, host, port, ciphers_arg="ECDHE+AESGCM"):
   ...
   self.client = HelperClient(self.server_address,sock=_sock) #cb_ignore_read_exception=self._cb_ignore_read_exception,cb_ignore_write_exception=self._cb_ignore_write_exception)
 def _setUpPems(self):
